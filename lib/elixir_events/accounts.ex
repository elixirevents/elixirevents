defmodule ElixirEvents.Accounts do
  @moduledoc """
  ...
  alias ElixirEvents.Accounts.{User, UserNotifier, UserToken}
  ...
  See `ElixirEvents.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `ElixirEvents.Accounts.User.password_changeset/3` for a list of supported options.
