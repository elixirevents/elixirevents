...
config :elixir_events, ElixirEventsWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "vwOksN3JTJKO/C1MicOpvkLXSIOaQaRjWum0ZXzatQ9HKb0gYP4BzeO6rD+1lRU6",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:elixir_events, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:elixir_events, ~w(--watch)]}
  ]
...
config :elixir_events, ElixirEventsWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/elixir_events_web/router\.ex$",
      ~r"lib/elixir_events_web/(controllers|live|components)/.*\.(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :elixir_events, dev_routes: true
